...
from moveit_msgs.msg import OrientationConstraint, Constraints, CollisionObject, MoveGroupAction, MoveGroupGoal, MoveGroupFeedback, MoveGroupResult, JointConstraint
...
class ControllerServer(object):
	def __init__(planner):
		#Initialize planner

#Request: takes in pose and orientation constraints
#Returned message: success/failure
def callback(request):
	#Initialize planner

	#Execute trajectory with planner
